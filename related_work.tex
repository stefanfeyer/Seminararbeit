...
nur gedankenstütze: "In order to create a study design to evaluate the perspective and learning we here take a look on how other researchers cinducted their studies"

\subsection{Tasks}
Jacky Chan et al. \todo created a VR dance training system. The dance student is presented a virtual avatar performing dance moves of different styles. The avatars movement is based on the motion capturing data of a professional dancer.


\subsection{Method}
Jacky Chan et al. \todo use an optical motion capturing system to compare the movements performed by the student with movements from the avatar.


\subsection{Measures}
Jacky Chan et al. \todo defined 19 body parts that are considered in the measure of the performance of the dancing student. They name three features to compare the difference between two motions common: joint position, joint velocity and joint angle. Chan investigated which of these features suits most to judge the two dancing motions. The outcome of this investigation names the joint position to have the highest discriminative power.
