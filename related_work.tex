...
%Computer aided Motor learning proved to be vast topic in recent research. Systems exist e.g. for learning dancing with web technologies \cite{Bakogianni2007},
%dancing with motion capturing \cite{Chan2007}
%dancing kinect CAVE \cite{Ahmad2016}
%boxing game \cite{Sidharta2005}
%rehab \cite{Holden1999}



table with overall conclusion
\begin{table}[H]
